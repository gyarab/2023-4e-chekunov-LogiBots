...
func _ready():
	...
	LevelClass.save_level(5,[Vector2(3,4)],boxes,[[Vector2(10,5),0]],[[Vector2(1,3),-10000],[Vector2(1,5), -10000]],[],"adding together","Add two numbers from red speakers, if sum is positive whrite 1, if zero write zero, if negative whrite -1")
